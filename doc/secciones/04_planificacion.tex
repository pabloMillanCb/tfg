...
\begin{figure}[h]
    \centering
    \includegraphics[scale=0.50]{burndonwn1}
...
\begin{table}[H]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			\rowcolor[HTML]{EFEFEF} 
			\textbf{Tarea: TRA-33}           & \textbf{Horas estimadas: 1}      & \textbf{Horas totales: 1}            & \multicolumn{2}{l|}{\cellcolor[HTML]{EFEFEF}\textbf{HU asociada RA-10}} \\ \hline
...
\begin{table}[H]
	\resizebox{\textwidth}{!}{%
		\begin{tabular}{|l|l|l|l|l|}
			\hline
			\rowcolor[HTML]{EFEFEF} 
			\textbf{Tarea: TRA-41}           & \textbf{Horas estimadas: 1}      & \textbf{Horas totales: 2}            & \multicolumn{2}{l|}{\cellcolor[HTML]{EFEFEF}\textbf{HU asociada RA-10.2}} \\ \hline
