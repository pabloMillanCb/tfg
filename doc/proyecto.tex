...
\begin{document}
	...
	\vspace*{\fill}
	\begin{quote}
		\textit{``Making the mother of all omelettes here, Jack. \\ Can't fret over every egg!''}
	\end{quote}	
	\vspace*{\fill}
	\tableofcontents
	...
	% Introducción 
	\input{secciones/01_introduccion _y_fundamentos}
	...
	% 	2. Propuesta
	\input{secciones/03_estado_de_ra}
